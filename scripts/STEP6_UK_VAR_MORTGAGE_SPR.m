%% UK VAR (Mortgage spread)
% Set endogenous UK
vNamesLongSOE = {'1yr rate';'CPI';'Exch. Rate ($ per £)';'Mortgage Spread';'Real GDP'};
vNamesSOE      = {'i_1YR';'CPI'; 'FX';'mortg_spr'; 'ONS_GDP'};
...
SaveFigure([folderOut 'UK mortgage spread'],highQuality)
close all
