function [FEVD, VAR, IRFjunk] = VARfevd(VAR,VARopt,varargin)
% =======================================================================
...
if isempty(varargin)
    ...
    IRFjunk = varargin{1};
    sigma = squeeze(IRFjunk(1,:,:))*squeeze(IRFjunk(1,:,:))';
end
...
for mm = 1:nvar % loop for the shocks
    ...
    for kk = 2:nsteps;
        ...
        MSE(:,:,kk) = MSE(:,:,kk-1) + PSI(:,:,kk)*(invA*invA')*PSI(:,:,kk)';
    end;
