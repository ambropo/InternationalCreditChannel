...
VARopt.ENDO      = [];    % original endogenous variables
VARopt.EXOG      = [];    % original exogenous variables
VARopt.nlag      = [];    % number of lags of endogenous
VARopt.nlag_ex   = [];    % number of lags of exogenous
VARopt.const     = [];    % deterministic (const, trends,..)
...
VARopt.S         = [];    % Orthonormal matrix (for 'sr' identification only)
