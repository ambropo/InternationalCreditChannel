function out = DateOption(fo_year,lo_year,frequency,fo_period,lo_period)
% =======================================================================
...
if strcmp(frequency,'y')
    [out.dates, out.dates_short] = MakeDate(fo_year,nobs,frequency);
else
    [out.dates, out.dates_short] = MakeDate(fo_year,nobs,frequency,fo_period);
end
